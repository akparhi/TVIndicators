...
Showvwap = input(true, title = 'Show Fast WT', type = input.bool)
...
newRSI = sma(stoch(close, high, low, 40), 2)
...
// Stochastic RSI
SRSI_k_Fast = sma(stoch(close, high, low, 81), 2)
...
// VWAP
plot(Showvwap ? wtVwap : na, title = 'VWAP', color = colorYellow, style = plot.style_area, linewidth = 2, transp = 45)
...
plot(newRSI, title = 'New RSI', color = #e600e6, linewidth = 2, transp = 25)
plot(SRSI_k_Fast, title = 'New Stoch', color = newStochColor, linewidth = 2, transp = 25)
